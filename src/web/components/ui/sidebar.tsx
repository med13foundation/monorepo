...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("hidden md:block", "peer", "group", "text-sidebar-foreground")}
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "duration-normal relative h-svh w-[--sidebar-width] bg-transparent transition-[width] ease-soft-out",
            "group-data-[collapsible=offcanvas]:w-0",
            side === "left" ? "group-data-[side=right]:rotate-180" : "group-data-[side=left]:rotate-180",
        ...
        <div
          className={cn(
            "duration-normal fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-soft-out md:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex size-full flex-col bg-gradient-to-b from-brand-primary/10 via-sidebar to-brand-secondary/10 text-sidebar-foreground group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground/60 outline-none ring-sidebar-ring transition-all duration-200 ease-out hover:bg-sidebar-primary/5 hover:text-sidebar-foreground/80 focus-visible:ring-2 focus-visible:ring-sidebar-primary/20 [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-current",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 rounded-xl p-2 text-left text-sm outline-none ring-sidebar-ring transition-all duration-200 ease-out overflow-hidden text-sidebar-foreground/60 hover:bg-sidebar-primary/5 hover:text-sidebar-foreground/80 focus-visible:ring-2 focus-visible:ring-sidebar-primary/20 active:bg-sidebar-primary/10 active:text-sidebar-foreground/90 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 data-[active=true]:bg-sidebar-primary/10 data-[active=true]:border data-[active=true]:border-sidebar-primary/30 data-[active=true]:font-semibold data-[active=true]:text-sidebar-primary data-[state=open]:hover:bg-sidebar-primary/5 data-[state=open]:hover:text-sidebar-foreground/80 group-data-[collapsible=icon]:!size-12 group-data-[collapsible=icon]:!gap-0 group-data-[collapsible=icon]:!p-3 group-data-[collapsible=icon]:justify-center [&>span:last-child]:truncate [&>svg]:size-6 [&>svg]:shrink-0 [&>svg]:text-current",
  {
    variants: {
      variant: {
        default: "hover:bg-sidebar-primary/5 hover:text-sidebar-foreground/80",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-primary/5 hover:text-sidebar-foreground/80 hover:shadow-[0_0_0_1px_hsl(var(--sidebar-primary)/20)]",
      },
      size: {
        default: "h-9 text-sm",
        sm: "h-8 text-xs",
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground/60 outline-none ring-sidebar-ring transition-all duration-200 ease-out hover:bg-sidebar-primary/5 hover:text-sidebar-foreground/80 focus-visible:ring-2 focus-visible:ring-sidebar-primary/20 peer-hover/menu-button:text-sidebar-foreground/80 [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-current",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 after:md:hidden",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("flex items-center gap-2 rounded-md h-8 px-2", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground/60 outline-none ring-sidebar-ring transition-all duration-200 ease-out hover:bg-sidebar-primary/5 hover:text-sidebar-foreground/80 focus-visible:ring-2 focus-visible:ring-sidebar-primary/20 active:bg-sidebar-primary/8 active:text-sidebar-foreground/90 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-current",
