    ...
    *,
    ...
    steps: list[
        ...
        Step.from_callable(
            ...
            name="normalize_pubmed_discovery_output",
        ),
        ConditionalStep(
                ...
                "run_policy": Pipeline(
                    steps=[
                        Step.from_callable(
                            ...
                            name="prepare_pubmed_dictionary_policy_input",
                        ),
                        Step(
                        ...
                        Step.from_callable(
                            ...
                            name="normalize_pubmed_dictionary_policy_output",
                        ),
                    ],
                ),
                "skip_policy": Pipeline(
                    steps=[
                        Step.from_callable(
                            ...
                            name="restore_pubmed_entity_recognition_contract",
                        ),
                    ],
                ),
            },
