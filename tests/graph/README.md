...
This checklist maps the graph architecture contract in `docs/graph/architecture.md`
...
| Participant resolution + backfill | `tests/unit/application/services/test_kernel_claim_projection_readiness_service.py`, `tests/integration/api/test_hypothesis_routes_api.py` |
...
| Hypothesis lineage + non-projection | `tests/unit/application/services/test_hypothesis_generation_service.py`, `tests/integration/api/test_hypothesis_routes_api.py` |
| Graph read-model consistency | `tests/integration/api/test_kernel_routes_api.py`, `tests/integration/api/test_kernel_graph_view_api.py` |
| Conflict detection | `tests/integration/api/test_kernel_routes_api.py` |
| Research-space isolation | `tests/unit/infrastructure/test_graph_query_repository.py`, `tests/integration/api/test_hypothesis_routes_api.py`, `tests/integration/kernel/test_graph_dictionary_hard_guarantees.py` |
