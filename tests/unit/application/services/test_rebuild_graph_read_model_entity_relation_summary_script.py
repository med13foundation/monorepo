"""Unit tests for the entity-relation summary rebuild script."""
...
from scripts import rebuild_graph_read_model_entity_relation_summary as rebuild_script
...
def test_run_rebuild_for_single_space(monkeypatch: pytest.MonkeyPatch, capsys) -> None:
    ...
    assert "model=entity_relation_summary" in capsys.readouterr().out
...
def test_run_rebuild_globally_can_emit_json(capsys) -> None:
    ...
    assert '"model_name": "entity_relation_summary"' in output
