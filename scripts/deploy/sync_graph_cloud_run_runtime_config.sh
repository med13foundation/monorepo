...
if [[ -n "${MED13_ENABLE_GRAPH_SEARCH_AGENT:-}" ]]; then
  graph_env_pairs+=(
    "MED13_ENABLE_GRAPH_SEARCH_AGENT=${MED13_ENABLE_GRAPH_SEARCH_AGENT}"
  )
fi
if [[ -n "${MED13_ENABLE_RELATION_SUGGESTIONS:-}" ]]; then
  graph_env_pairs+=(
    "MED13_ENABLE_RELATION_SUGGESTIONS=${MED13_ENABLE_RELATION_SUGGESTIONS}"
  )
fi
if [[ -n "${MED13_ENABLE_HYPOTHESIS_GENERATION:-}" ]]; then
  graph_env_pairs+=(
    "MED13_ENABLE_HYPOTHESIS_GENERATION=${MED13_ENABLE_HYPOTHESIS_GENERATION}"
  )
fi
